...
See https://confluence.suse.com/display/CECO/Scaling+Experiments+2025#ScalingExperiments2025-Try6:VClusterswithk3konAWS for notes.
...
* added docker.io mirror
* etcd quota increase in rke2 install script
* max_pods fix
* allow more SSH connections to bastion host
* configured node_cidr_mask to /22
* configured larger cidr blocks /20
