resource "aws_instance" "instance" {
  ...
  availability_zone      = var.network_backend_variables.availability_zone
  key_name               = var.network_backend_variables.ssh_key_name
  subnet_id              = var.public ? var.network_backend_variables.public_subnet_id : var.network_backend_variables.private_subnet_id
  vpc_security_group_ids = [var.public ? var.network_backend_variables.public_security_group_id : var.network_backend_variables.private_security_group_id]
...
resource "null_resource" "host_configuration" {
  ...
  connection {
    host        = var.network_backend_variables.ssh_bastion_host == null ? aws_instance.instance.public_dns : aws_instance.instance.private_dns
