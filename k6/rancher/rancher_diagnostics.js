...
export const eventAPITime = new Trend('api_event_duration', true)
export const k8sEventAPITime = new Trend('api_k8sevent_duration', true)
export const settingsAPITime = new Trend('api_setting_duration', true)
export const clusterRoleAPITime = new Trend('api_clusterrole_duration', true)
export const crdAPITime = new Trend('api_crd_duration', true)
export const roleAPITime = new Trend('api_role_duration', true)
export const roleBindingAPITime = new Trend('api_rolebinding_duration', true)
export const clusterRoleBindingAPITime = new Trend('api_clusterrolebinding_duration', true)
export const globalRoleBindingAPITime = new Trend('api_globalrolebinding_duration', true)
export const configMapAPITime = new Trend('api_configmap_duration', true)
export const serviceAccountAPITime = new Trend('api_serviceaccount_duration', true)
export const secretAPITime = new Trend('api_secret_duration', true)
export const podAPITime = new Trend('api_pod_duration', true)
export const deploymentAPITime = new Trend('api_deployment_duration', true)
export const serviceAPITime = new Trend('api_service_duration', true)
export const apiServiceAPITime = new Trend('api_apiservice_duration', true)
export const roleTemplateAPITime = new Trend('api_roletemplate_duration', true)
export const projectAPITime = new Trend('api_project_duration', true)
export const namespaceAPITime = new Trend('api_namespace_duration', true)
