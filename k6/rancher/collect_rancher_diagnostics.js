...
export const options = {
  ...
  thresholds: {
    ...
    [`api_event_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_k8sevent_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_setting_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_clusterrole_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_crd_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_role_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_rolebinding_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_clusterrolebinding_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_globalrolebinding_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_configmap_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_serviceaccount_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_secret_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_pod_duration_ms`]: ['avg<4000', 'p(95)<2000'],
    [`api_deployment_duration_ms`]: ['avg<4000', 'p(95)<2000'],
    [`api_service_duration_ms`]: ['avg<4000', 'p(95)<2000'],
    [`api_apiservice_duration_ms`]: ['avg<4000', 'p(95)<2000'],
    [`api_roletemplate_duration_ms`]: ['avg<4000', 'p(95)<2000'],
    [`api_project_duration_ms`]: ['avg<1000', 'p(95)<2000'],
    [`api_namespace_duration_ms`]: ['avg<1000', 'p(95)<2000'],
  }
};
