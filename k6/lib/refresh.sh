...
curl -o js-yaml-4.1.1.mjs https://raw.githubusercontent.com/nodeca/js-yaml/4.1.1/dist/js-yaml.mjs
...
curl -o k6-reporter-3.0.4.js https://raw.githubusercontent.com/benc-uk/k6-reporter/refs/tags/3.0.1/dist/bundle.js
